namespace PartyScraper3._0
{
    partial class Main
    {
        ...
        private void InitializeComponent()
        {
            ...
            modificationDateSwitch = new ReaLTaiizor.Controls.MaterialSwitch();
            ...
            outputPanel = new ReaLTaiizor.Controls.MaterialExpansionPanel();
            outputProgress = new ReaLTaiizor.Controls.ProgressIndicator();
            outputLabel = new ReaLTaiizor.Controls.MaterialLabel();
            ...
            materialExpansionPanel1.MinimumSize = new Size(261, 61);
            ...
            materialDivider1.Location = new Point(28, 137);
            ...
            moduleOptionsPanel.Controls.Add(modificationDateSwitch);
            ...
            // 
            // modificationDateSwitch
            // 
            modificationDateSwitch.AutoSize = true;
            modificationDateSwitch.Checked = true;
            modificationDateSwitch.CheckState = CheckState.Checked;
            modificationDateSwitch.Depth = 0;
            modificationDateSwitch.Location = new Point(24, 357);
            modificationDateSwitch.Margin = new Padding(0);
            modificationDateSwitch.MouseLocation = new Point(-1, -1);
            modificationDateSwitch.MouseState = ReaLTaiizor.Helper.MaterialDrawHelper.MaterialMouseState.HOVER;
            modificationDateSwitch.Name = "modificationDateSwitch";
            modificationDateSwitch.Ripple = true;
            modificationDateSwitch.Size = new Size(279, 37);
            modificationDateSwitch.TabIndex = 9;
            modificationDateSwitch.Text = "Overwrite file modification time";
            modificationDateSwitch.UseAccentColor = true;
            modificationDateSwitch.UseVisualStyleBackColor = true;
            modificationDateSwitch.CheckedChanged += modificationDateSwitch_CheckedChanged;
            // 
            // postNumberTextbox
            // 
            ...
            // outputPanel
            // 
            outputPanel.BackColor = Color.FromArgb(255, 255, 255);
            outputPanel.Controls.Add(outputProgress);
            outputPanel.Controls.Add(outputLabel);
            outputPanel.Depth = 0;
            outputPanel.Description = "Current operations";
            outputPanel.ExpandHeight = 232;
            outputPanel.Font = new Font("Roboto", 14F, FontStyle.Regular, GraphicsUnit.Pixel);
            outputPanel.ForeColor = Color.FromArgb(222, 0, 0, 0);
            outputPanel.Location = new Point(1196, 229);
            outputPanel.Margin = new Padding(3, 16, 3, 16);
            outputPanel.MouseState = ReaLTaiizor.Helper.MaterialDrawHelper.MaterialMouseState.HOVER;
            outputPanel.Name = "outputPanel";
            outputPanel.Padding = new Padding(24, 64, 24, 16);
            outputPanel.ShowValidationButtons = false;
            outputPanel.Size = new Size(371, 232);
            outputPanel.TabIndex = 13;
            outputPanel.Title = "Output";
            outputPanel.Click += ReleaseKeyboard;
            // 
            // outputProgress
            // 
            outputProgress.Location = new Point(140, 110);
            outputProgress.MinimumSize = new Size(50, 50);
            outputProgress.Name = "outputProgress";
            outputProgress.P_AnimationColor = Color.DimGray;
            outputProgress.P_AnimationSpeed = 100;
            outputProgress.P_BaseColor = Color.DarkGray;
            outputProgress.Size = new Size(80, 80);
            outputProgress.TabIndex = 3;
            outputProgress.Text = "Progress";
            outputProgress.Visible = false;
            outputProgress.Click += ReleaseKeyboard;
            // 
            // outputLabel
            // 
            outputLabel.Depth = 0;
            outputLabel.Font = new Font("Roboto", 14F, FontStyle.Regular, GraphicsUnit.Pixel);
            outputLabel.Location = new Point(27, 193);
            outputLabel.MouseState = ReaLTaiizor.Helper.MaterialDrawHelper.MaterialMouseState.HOVER;
            outputLabel.Name = "outputLabel";
            outputLabel.Size = new Size(317, 23);
            ...
            MaximumSize = new Size(2560, 1400);
            Name = "Main";
        ...
        private ReaLTaiizor.Controls.MaterialExpansionPanel outputPanel;
        private ReaLTaiizor.Controls.MaterialLabel outputLabel;
        private ReaLTaiizor.Controls.ProgressIndicator outputProgress;
        private ReaLTaiizor.Controls.MaterialSwitch modificationDateSwitch;
    }
}
